...
export const DeleteCollection: UniversalComponent<DeleteCollectionType> =
  createUniversalComponent<DeleteCollectionType>(
    () => {
      ...
      const [deleteCollection, { status }] = useMutation(async () => {
        await api.deleteCollection(Number(id), { recursive });
          ...
          {data ? (
            <>
              {data.fullDelete ? (
                <>
                  <p>
                    This collection will be fully deleted, reimporting will refresh linking properties and metadata.
                  </p>
                  <InputContainer>
                    <InputCheckboxContainer>
                      <InputCheckboxInputContainer $checked={recursive}>
                        <Input
                          type="checkbox"
                          id="recursive"
                          checked={recursive}
                      ...
                      <InputLabel htmlFor="recursive">Delete all manifests</InputLabel>
                    </InputCheckboxContainer>
                  </InputContainer>
                </>
              ) : (
