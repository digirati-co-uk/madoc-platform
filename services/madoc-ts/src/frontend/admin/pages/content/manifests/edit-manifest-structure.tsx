...
export const EditManifestStructure: UniversalComponent<EditManifestStructureType> =
  createUniversalComponent<EditManifestStructureType>(
    () => {
      const api = useApi();
      ...
      const {
        ...
        updatedAt,
      } = apiHooks.getManifestById(() => [Number(params.id)]);
