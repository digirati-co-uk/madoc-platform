...
const markdownStyles = [
  ...
  '[&_a]:text-[var(--madoc-accent-link)] [&_a]:underline [&_a]:underline-offset-2 hover:[&_a]:brightness-75',
  ...
  '[&_input[type=checkbox]]:h-4 [&_input[type=checkbox]]:w-4 [&_input[type=checkbox]]:accent-[var(--madoc-accent)]',
