...
import { deleteAnnotationStyle } from './delete-annotation-style';
...
export const annotationStyles: Record<keyof any, RouteWithParams<any>> = {
  ...
  'delete-annotation-style': [TypedRouter.DELETE, '/api/madoc/annotation-styles/:id', deleteAnnotationStyle],
