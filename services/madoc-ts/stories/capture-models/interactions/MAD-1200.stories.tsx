...
export default { title: 'Capture model interactions / MAD-1200', component: CaptureModelTestHarness };
...
export const DoubleModelExample = {
  args: {
    captureModel: mad1200fixture1,
...
export const DoubleModelExampleNoRevision = {
  args: {
    captureModel: mad1200fixture1,
    target: {
      manifestUri: 'https://www.omeka.ugent.be/manifests/iiif/2/2636/manifest',
...
export const BrokenRevisionExample = {
  args: {
    captureModel: mad1200fixture2,
    target: {
...
export const JestTestCaseWithRevision = {
  args: {
    captureModel: mad1200fixture3,
    target: {
      manifestUri: 'https://view.nls.uk/manifest/9713/97134412/manifest.json',
...
export const NoRevisionExample = {
  args: {
    captureModel: mad1200fixture2,
    target: {
      manifestUri: 'https://view.nls.uk/manifest/9713/97134412/manifest.json',
...
export const NoRevisionExampleWithoutModelRoot = {
  args: {
