...
/**
 * Header class
 * Manipulates header DOM for mobile devices
 */
...
var Header = exports.Header = function () {
  ...
  function Header() {
    ...
    this.searchAndUserClass = 'c-header__search-and-user';
    this.navigationPrimaryClass = 'c-navigation-primary';
    this.navigationPrimaryToggleClass = 'c-navigation-primary__toggle';
  }

  /**
   * domReady: To be called when the dom is ready
   */
  ...
  _createClass(Header, [{
    ...
    value: function domReady() {
      ...
      this.headerElement = document.querySelector('.' + this.headerClass);
      this.searchAndUserElement = document.querySelector('.' + this.searchAndUserClass);
      this.navigationPrimaryToggleElement = document.querySelector('.' + this.navigationPrimaryToggleClass);
      this.navigationPrimaryElement = document.querySelector('.' + this.navigationPrimaryClass);
      window.onresize = function (e) {
        return _this.resizeDebounce(e);
      };
      this.resize();
    }

    /**
     * resizeDebounce: Batches resize events into a single call
     */

  }, {
    key: 'resizeDebounce',
    value: function resizeDebounce() {
      var _this2 = this;
    ...
    /**
     * resize: Called in response to a debounced resize event
     */
    ...
    value: function resize() {
      ...
      if (w <= this.mobileBP) {
        this.moveSearchAndUserMobile();
      } else {
        this.moveSearchAndUserDesktop();
      }
    }

    /**
     * moveSearchAndUserMobile: Moves the search and user login elements for mobile
     */

  }, {
    key: 'moveSearchAndUserMobile',
    value: function moveSearchAndUserMobile() {
      this.navigationPrimaryElement.insertBefore(this.searchAndUserElement, this.navigationPrimaryToggleElement.nextSibling);
      // this.searchAndUserElement.style.display = 'none';
    }

    /**
     * moveSearchAndUserDesktop: Moves the search and user login elements for desktop
     */

  }, {
    key: 'moveSearchAndUserDesktop',
    value: function moveSearchAndUserDesktop() {
      this.headerElement.appendChild(this.searchAndUserElement);
    }
  }]);
 ...
 * Attaches mobile nav behaviour
 */

var NavigationPrimary = exports.NavigationPrimary = function () {

  /**
   * Constructor
   */
  function NavigationPrimary() {
    _classCallCheck(this, NavigationPrimary);

    this.toggleElementClass = 'js-navigation-primary__toggle-link';
    this.toggleElementActiveClass = 'c-navigation-primary__toggle-link--open';
    this.navElementClass = 'c-navigation-primary__nav';
    this.navContainerClass = 'js-navigation-primary';
    this.navContainerActiveClass = 'c-navigation-primary--open';
  }
  ...
  _createClass(NavigationPrimary, [{
    key: 'domReady',
    value: function domReady() {
      var _this = this;

      this.toggleElement = document.querySelector('.' + this.toggleElementClass);
      this.toggleElement.addEventListener('click', function (e) {
        return _this.toggleNavigation(e);
      });

      this.navContainer = document.querySelector('.' + this.navContainerClass);

      this.navElements = document.querySelectorAll('.' + this.navElementClass);
      this.createSubnavToggleElems();
    }

    /**
     * appendToggleElem: Attaches a subnav toggle to the provided element
     * @param elem
     */

  }, {
    key: 'appendToggleElem',
    value: function appendToggleElem(elem) {
      var subNavToggleElement = document.createElement('button');
      subNavToggleElement.classList.add('c-navigation-primary__subnav-toggle');
      subNavToggleElement.setAttribute('role', 'button');
      subNavToggleElement.setAttribute('title', 'toggle sub navigation');
      subNavToggleElement.setAttribute('aria-label', 'toggle sub navigation');
      subNavToggleElement.addEventListener('click', this.toggleSubNavigation);
      elem.appendChild(subNavToggleElement);
    }

    /**
     * createSubnavToggleElems: Builds subnav toggle elements
     */

  }, {
    key: 'createSubnavToggleElems',
    value: function createSubnavToggleElems() {
      var _this2 = this;

      this.navItemsWithChildren = [];
      // IE only supports forEach for arrays :(
      [].concat(_toConsumableArray(this.navElements)).forEach(function (item) {
        var subNavChildren = item.querySelectorAll('ul');
        if (subNavChildren.length) {
          [].concat(_toConsumableArray(subNavChildren)).forEach(function (subNavItem) {
            _this2.navItemsWithChildren.push(subNavItem);
          });
        }
      });
      [].concat(_toConsumableArray(this.navItemsWithChildren)).forEach(function (item) {
        item.parentNode.classList.add('js-navigation-primary__subnav--has-children');
        _this2.appendToggleElem(item.parentNode);
      });
    }

    /**
     * toggleNavigation: Click event handler for the navigation toggle
     * @param e
     */
    ...
    value: function toggleNavigation(e) {
      e.preventDefault();
      this.toggleElement.classList.toggle(this.toggleElementActiveClass);
      this.navContainer.classList.toggle(this.navContainerActiveClass);
    }

    /**
     * toggleNavigation: Click event handler for the sub navigation toggle
     */

  }, {
    key: 'toggleSubNavigation',
    value: function toggleSubNavigation() {
      var parentElem = this.parentNode;
      parentElem.classList.toggle('c-navigation-primary__item--open');
      this.classList.toggle('c-navigation-primary__subnav-toggle--open');
    }
  }]);
...
var _navigationPrimary = require('../common/components/navigation-primary.js');

var _header = require('../common/components/header.js');

// For IE
var navigationPrimary = new _navigationPrimary.NavigationPrimary();
