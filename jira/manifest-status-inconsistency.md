...
- `/services/madoc-ts/src/routes/site/site-manifest-tasks.ts`
- `/services/madoc-ts/src/routes/site/site-canvas-tasks.ts`
- `/services/madoc-ts/src/routes/projects/assign-random-resource.ts`
- `/services/madoc-ts/src/gateway/tasks/crowdsourcing-manifest-task.ts`
...
- `/services/madoc-ts/src/gateway/tasks/crowdsourcing-task.ts:402`
- `/services/madoc-ts/src/gateway/tasks/crowdsourcing-task.ts:412`
...
- `/services/madoc-ts/src/routes/site/site-manifest-tasks.ts:143`
- `/services/madoc-ts/src/routes/site/site-canvas-tasks.ts:78`
...
- `/services/madoc-ts/src/routes/projects/assign-random-resource.ts:55`
...
- `/services/madoc-ts/src/gateway/tasks/crowdsourcing-manifest-task.ts:202`
