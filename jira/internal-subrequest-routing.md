...
- Api client + fetcher:
  ...
  - `/services/madoc-ts/src/gateway/fetch-json.ts`
...
- Representative call sites (server-side):
  - `/services/madoc-ts/src/routes/site/site-search.ts`
  - `/services/madoc-ts/src/routes/site/site-user-autocomplete.ts`
  - `/services/madoc-ts/src/routes/media/generate-thumbnails.ts`
  - `/services/madoc-ts/src/routes/projects/project-members.ts`
  - `/services/madoc-ts/src/capture-model-server/migration/migrate-model-task.ts`
...
- New module (suggested):
  - `/services/madoc-ts/src/gateway/internal-request.ts`
...
- New fetcher (suggested):
  - `/services/madoc-ts/src/gateway/internal-fetch-json.ts`
